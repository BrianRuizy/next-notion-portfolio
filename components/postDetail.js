      ...
      <header className="bg-black py-4 md:py-16 h-screen md:h-auto">
        <div className="flex flex-col  gap-12">
          <div className="container max-w-2xl mx-auto px-6 flex justify-between items-center">
            <button
              className="text-white/75 hover:opacity-75 transition duration-200 ease-in-out p-2 rounded-full bg-white/20"
              onClick={() => router.back()}
            >
            ...
            <div className="flex flex-row gap-4">
              <button className="text-white/75 hover:opacity-75 transition duration-200 ease-in-out p-2 rounded-full bg-white/20">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
